        ...
        overlay={
          <>
            <div className="relative h-[250vh]">
              <div className="absolute right-5 top-[50vh] max-w-sm p-4 text-left lg:max-w-xl">
                <h1 className="red-hat-display-black text-6xl text-blue-500 lg:text-9xl">
                  Join the Pride
                </h1>
                <p className="mt-6 font-sans text-xl font-medium text-slate-500 lg:text-2xl">
                  Join us in celebrating love, diversity, and equality at this year&#39;s Pride
                  event
                </p>
                <div className="mt-64">
                  <h2 className="red-hat-display-black pt-96 text-5xl text-slate-500 lg:text-8xl">
                    Oct. 24
                  </h2>
                  <p className="red-hat-display-black mt-6 font-sans text-3xl text-blue-500 lg:text-5xl">
                    Taipei
                  </p>
                </div>
              </div>
